          ...
          <div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-slate-600/30">
            <div className="w-full max-w-md">
              ...
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-green-200 mb-2">Create Account</h2>
                <p className="text-green-400">Sign up for a new account</p>
              </div>
          ...
          <div className="hidden md:w-1/2 md:flex items-center justify-center p-6">
            <div>
              <img
                ...
                />
                <div className="mt-6 text-center">
                  <h3 className="text-xl font-medium text-green-400">Start Your Journey Today</h3>
